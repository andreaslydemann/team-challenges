...
export namespace ChallengeActions {
  ...
  export const getChallenges: ActionCreator<ThunkAction<Promise<Action>, RootState.ChallengeState, void>> = () => {
    ...
    function success(challenges: ChallengeModel[]) { return { type: ChallengeConstants.GET_CHALLENGES_SUCCESS, payload: challenges } }
  ...
  export const getChallenge: ActionCreator<ThunkAction<Promise<Action>, RootState.ChallengeState, void>> = (id: string) => {
    ...
    function request() { return { type: ChallengeConstants.GET_CHALLENGE_REQUEST } }
    function success(challenge: ChallengeModel) { return { type: ChallengeConstants.GET_CHALLENGE_SUCCESS, payload: challenge } }
    function failure(error: string) { return { type: ChallengeConstants.GET_CHALLENGE_FAILURE, payload: error } }
  };

  export const selectFile = createAction<PartialPick<ChallengeModel.ChallengeDetailsModel, 'file'>>(ChallengeConstants.SELECT_FILE);
  export const removeFile = createAction(ChallengeConstants.REMOVE_FILE);
